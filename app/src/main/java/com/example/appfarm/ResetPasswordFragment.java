...
public class ResetPasswordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        emailIconContainer = view.findViewById(R.id.forgot_password_email_iconContainer);
                                ...
                                if (task.isSuccessful()){
                                    ...
                                    scaleAnimation.setAnimationListener(new Animation.AnimationListener() {
                                        ...
                                        public void onAnimationRepeat(Animation animation) {
                                            emailIcon.setImageResource(R.mipmap.green_email_id_foreground);

                                        }
                                    });

                                    emailIcon.startAnimation(scaleAnimation);
                                    Toast.makeText(getActivity(),"Recovery email sent successfully! Check your Inbox.",Toast.LENGTH_LONG);
